...
namespace SoLoud
{
	...
	result sdl2static_init(SoLoud::Soloud *aSoloud, int aDevice = -1, unsigned int aFlags = Soloud::CLIP_ROUNDOFF, unsigned int aSamplerate = 44100, unsigned int aBuffer = 2048, unsigned int aChannels = 2);
